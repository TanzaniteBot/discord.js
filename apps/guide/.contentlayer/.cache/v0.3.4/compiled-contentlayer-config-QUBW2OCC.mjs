...
// src/styles/code-hike-theme-dark-plus.json
var code_hike_theme_dark_plus_default = {
...
var contentlayer_config_default = makeSource({
	...
	mdx: {
		remarkPlugins: [remarkGfm, [remarkCodeHike, { theme: code_hike_theme_dark_plus_default, lineNumbers: true }]],
		rehypePlugins: [
			rehypeSlug,
			[
...
export { Content, contentlayer_config_default as default };
//# sourceMappingURL=compiled-contentlayer-config-QUBW2OCC.mjs.map
